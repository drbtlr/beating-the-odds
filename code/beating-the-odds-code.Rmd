...
This last group can be helpful as the information can be used to provide targeted support.
...
Confidence intervals allowed us to determination whether a value of zero was just as plausible as the estimated residual. We identified schools as beating the odds if the 95 percent confidence interval did not include zero and the residual was positive.
