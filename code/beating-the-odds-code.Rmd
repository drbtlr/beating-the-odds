...
In addition, this guide will draw from OpenSDP-written functions defined in the `functions.R` document, which is located in the `R` folder of this guide’s [GitHub repository](https://github.com/drbtlr/beating-the-odds). Please make sure to have downloaded the entire GitHub repository to run this code.
...
prior_achieve_bto %>% 
  ...
  scale_color_manual(values = c("#999999", "#E69F00")) +
  bto_theme() +
  labs(x = "Math (percentile rank)", 
       y = "Reading (percentile rank)", 
       color = "",
